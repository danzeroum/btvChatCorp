...
@Component({
            ...
            <div class="delivery-card" [class]="d.status" (click)="toggleDetail(d)">
              <div class="delivery-header">
                ...
                <div class="delivery-meta">
                  @if (d.durationMs) { <span class="mono">{{ d.durationMs }}ms</span> }
                  <span class="mono">{{ d.createdAt | date:'dd/MM HH:mm:ss' }}</span>
  ...
  styles: [`
    ...
    .webhook-logs { padding: 28px 32px; background: var(--panel-2); min-height: 100vh; }
    ...
    .btn-ghost { background:none; border:1px solid var(--line); border-radius:8px; padding:8px 14px; cursor:pointer; font-size:13px; color: var(--ink); }
    ...
    .delivery-card { background: var(--white); border:1px solid var(--line); border-radius:10px; padding:14px 18px; cursor:pointer; transition:background 0.15s; }
    .delivery-card:hover { background: var(--panel); }
    ...
    .delivery-card.pending { border-left:3px solid var(--acc); }
    ...
    .event-name { font-size:13px; font-weight:500; color: var(--ink); }
    ...
    .delivery-meta { display:flex; align-items:center; gap:10px; font-size:12px; color: var(--ink-2); }
    .mono { font-family:'IBM Plex Mono',monospace; font-size:11px; }
    .delivery-detail { margin-top:14px; border-top:1px solid var(--line); padding-top:14px; display:grid; grid-template-columns:1fr 1fr; gap:16px; }
    .detail-col h4 { font-size:12px; font-weight:600; color: var(--ink); margin:0 0 6px; }
    .detail-col pre { background:#1e293b; color:#e2e8f0; border-radius:8px; padding:10px; font-size:11px; font-family:'IBM Plex Mono',monospace; overflow:auto; max-height:180px; margin:0; }
