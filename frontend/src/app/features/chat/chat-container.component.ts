...
@Component({
          ...
          @for (msg of messages; track msg.id) {
            <div [class]="'message ' + msg.role">
              ...
              <div class="message-body">
                <div class="message-content" [class.loading-dots]="msg.loading">{{ msg.content }}</div>
                @if (msg.role === 'assistant' && msg.sources?.length) {
                  <div class="sources">
                    <small>📎 {{ msg.sources?.length }} fonte(s) consultada(s)</small>
                  </div>
                }
  ...
  styles: [`
    ...
    .logo { font-size: 1rem; font-weight: 700; color: #fff; letter-spacing: 0.5px; }
    ...
    .message-content { padding: 0.75rem 1rem; border-radius: 12px; font-size: 0.9rem; line-height: 1.5; white-space: pre-wrap; }
    ...
    .sources { font-size: 0.75rem; color: #60a5fa; padding-left: 0.25rem; }
