-- Migration 003: Branding e Onboarding (Fase 6)
...
CREATE TABLE IF NOT EXISTS workspace_brandings (
    ...
    -- Chat
    chat_welcome_message      TEXT    NOT NULL DEFAULT 'Olá! Como posso ajudar?',
    chat_placeholder          VARCHAR(200) NOT NULL DEFAULT 'Faça uma pergunta...',
